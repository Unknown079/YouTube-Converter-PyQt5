...
class MP4(QMainWindow):
    ...
    def UI(self):
        ...
        self.button.setStyleSheet("background: #A52A2A; color: white; border: 1px solid black; border-radius: 4px; font: 10pt; font: 13pt; font-weight: bold;")
...
class MP3(QMainWindow):
    ...
    def UI(self):
        ...
        self.button.setFixedHeight(40)
        self.button.setFixedWidth(150)
        self.button.setStyleSheet("background: #A52A2A; color: white; border: 1px solid black; border-radius: 4px; font: 13pt; font-weight: bold;")
        self.button.clicked.connect(self.clicked)
